...
SERVICES = {
    "komuter": {
        "url": "https://storage.data.gov.my/transportation/ktmb/komuter_2026.parquet",
        "out_dir": Path("docs/data"),
    },
    "komuter_utara": {
        "url": "https://storage.data.gov.my/transportation/ktmb/komuter_utara_2026.parquet",
        "out_dir": Path("docs/data/komuter_utara"),
    },
    "ets": {
        "url": "https://storage.data.gov.my/transportation/ktmb/ets_2026.parquet",
        "out_dir": Path("docs/data/ets"),
    },
    "intercity": {
        "url": "https://storage.data.gov.my/transportation/ktmb/intercity_2026.parquet",
        "out_dir": Path("docs/data/intercity"),
    },
}
