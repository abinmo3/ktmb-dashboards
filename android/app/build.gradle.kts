...
android {
    namespace = "com.ktmb.crowdtrend"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.ktmb.crowdtrend"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
...
dependencies {
    ...
    // kotlinx.serialization (JSON for bundled assets)
    implementation("org.jetbrains.kotlinx:kotlinx-serialization-json:1.7.3")

    // Networking — Retrofit + OkHttp for GTFS live feed
    implementation("com.squareup.retrofit2:retrofit:2.11.0")
    implementation("com.squareup.okhttp3:okhttp:4.12.0")
    implementation("com.squareup.okhttp3:logging-interceptor:4.12.0")

    // Protobuf for GTFS-realtime parsing
