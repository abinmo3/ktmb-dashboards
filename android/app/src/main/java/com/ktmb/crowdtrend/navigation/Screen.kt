...
sealed class Screen(
    ...
    data object Home : Screen("home", "Network", Icons.Filled.Home)
    ...
    data object Alarms : Screen("alarms", "Alarms", Icons.Filled.NotificationsActive)
    data object Settings : Screen("settings", "Info", Icons.Filled.Info)

    companion object {
        val bottomNavItems = listOf(Home, Forecast, Live, Stations, Alarms, Settings)
    }
}
